...
class SaldoBodegaHandler extends Handler
{
    ...
    private function updateModelo($context, $detalle, &$isActual)
    {
        ...
        $this->$campoPeriodo = $this->cantidadRecepcionada;
        ...
        if ($this->producto->update($this->array)) {
            ...
            $this->replicarValorEnFilasDeAbajo($this->producto, $campoPeriodo, $this->cantidadRecepcionada);
     ...
     * @param bool &$isActual Referencia que indica si el periodo es actual.
    ...
    /**
     * Devuelve el campo de periodo anterior correspondiente al
